...
class AudioProvider with ChangeNotifier {
  ...
  AudioPlayer get audioPlayer => _audioPlayer; // 외부에서 AudioPlayer 인스턴스에 접근할 수 있도록 하는 getter

// 지정된 URL로 오디오를 설정하는 비동기 메서드
  Future<void> setUrl(String url) async {
    try {
      await _audioPlayer.setUrl(url); // URL로 오디오 설정
